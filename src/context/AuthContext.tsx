  ...
  const login = (identifier: string, password: string, role: string): boolean => {
    try {
      ...
      const mockUsers: User[] = [
        ...
        { id: '11', name: 'Ajay', email: 'ajay@oxford.edu', role: 'faculty', department: 'Computer Science', avatar: 'https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop', phone: '+91 9876543220', address: '123 Faculty Housing, Hyderabad', joinDate: '2020-06-01', rollNumber: 'FAC001' },
        { id: '12', name: 'Bhanu', email: 'bhanu@oxford.edu', role: 'faculty', department: 'Cybersecurity', avatar: 'https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop', phone: '+91 9876543221', address: '456 Faculty Housing, Hyderabad', joinDate: '2019-06-01', rollNumber: 'FAC002'},
        { id: '13', name: 'Chakresh', email: 'chakresh@oxford.edu', role: 'faculty', department: 'AIML', avatar: 'https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop', phone: '+91 9876543222', address: '789 Faculty Housing, Hyderabad', joinDate: '2021-06-01', rollNumber: 'FAC003' },
        { id: '14', name: 'Harika', email: 'harika@oxford.edu', role: 'faculty', department: 'Machine Learning', avatar: 'https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop', phone: '+91 9876543223', address: '101 Faculty Housing, Hyderabad', joinDate: '2022-06-01', rollNumber: 'FAC004' },
        { id: '17', name: 'Adbuth Singh', email: 'adbuth.singh@oxford.edu', role: 'hod', department: 'Computer Science', avatar: 'https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop', phone: '+91 9876543226', address: '789 Faculty Housing, Hyderabad', joinDate: '2015-06-01', rollNumber: 'HOD001' },
        { id: '18', name: 'Indhu', email: 'indhu@oxford.edu', role: 'principal', department: 'Administration', avatar: 'https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop', phone: '+91 9876543227', address: '101 Admin Block, Hyderabad', joinDate: '2010-06-01', rollNumber: 'PRI001' },
      ];
      ...
      const user = mockUsers.find(u => (u.rollNumber === identifier ) );
