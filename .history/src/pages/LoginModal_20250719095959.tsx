    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl p-8 animate-slide-up relative overflow-y-auto max-h-[90vh] scrollbar-white scrollbar-thumb-gray-300 scrollbar-track-gray-100">
              <button
                onClick={onClose}
