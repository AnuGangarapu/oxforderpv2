            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 animate-slide-up relative overflow-y-auto max-h-[90vh]">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-warning-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-white-700 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                >
